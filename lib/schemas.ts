...
export const aiSdkMessageSchema: z.ZodType<CoreMessage> = z.union([
  userMessageSchema,
  assistantMessageSchema,
  systemMessageSchema,
  toolMessageSchema,
]) as z.ZodType<CoreMessage>;

export const chatRequestSchema = z.object({
  messages: z.array(aiSdkMessageSchema).min(1, "Messages array cannot be empty."),
});
