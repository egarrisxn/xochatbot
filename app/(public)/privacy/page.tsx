      ...
      <div className='grid w-full grid-rows-1'>
        ...
        <div className='px-4 lg:px-0'>
          ...
          <p className='text-justify text-sm leading-tight lg:text-base lg:leading-normal'>
            ...
            sessions. Data provided to this site is exclusively used to support
            signing in and is not passed to any third party services, other than
            via SMTP or OAuth for the purposes of authentication.
          </p>
        </div>
        <div></div>
      </div>
